...
# Its responsibility is to query the system to determine what OS the system has, 
# fetch and install the appropriate build of Volta, and modify the user's profile.
