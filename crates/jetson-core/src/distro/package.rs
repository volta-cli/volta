...
///
/// This information will be stored in ~/.jetson/tools/user/packages/<package>.json.
///
...
///
/// This information will be stored in ~/.jetson/tools/user/bins/<bin-name>.json.
///
/// For an example, this looks like:
///
/// {
...
/// This is defined in RFC#27: https://github.com/jetson-cli/rfcs/pull/27
pub struct UserTool {
