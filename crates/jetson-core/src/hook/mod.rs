//! Provides types for working with Jetson hooks.
...
use jetson_fail::{Fallible, JetsonError, ResultExt};
use readext::ReadExt;

pub(crate) mod serial;
pub mod tool;

/// A hook for publishing Jetson events.
...
/// Lazily loaded Jetson hook configuration
...
/// Jetson hooks for an individual tool
...
/// Jetson hooks related to events.
