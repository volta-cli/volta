...
//! execution of a Jetson tool, including their current directory, Jetson
...
use jetson_fail::{throw, ExitCode, Fallible, JetsonError};
use semver::Version;
...
/// Represents the user's state during an execution of a Jetson tool. The session
...
///     - the Jetson hook configuration
///     - the inventory of locally-fetched Jetson tools
pub struct Session {
...
impl Session {
    ...
    pub fn add_event_error(&mut self, activity_kind: ActivityKind, error: &JetsonError) {
