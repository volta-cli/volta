...
impl SandboxBuilder {
    ...
    // pub fn node_archive_mock(mut self, for_version: &str) -> Self {
    //     // ISSUE(#145): this should actually use a real http server instead of these mocks
    //     let node_version_url = format!("^/v{}/node-v{}", for_version, for_version);
    ...
    //     let head_mock = mock(
    //         method_name("HEAD"),
    //         Matcher::Regex(node_version_url.clone()),
